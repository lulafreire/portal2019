...
$(document).ready(function () {
    ...
    var LINECHARTEXMPLE   = $('#lineChartExample'),
        ...
        BARCHARTTAREFAS   = $('#barChartTarefas'),
        BARCHARTIMAGDASS  = $('#barChartImaGdass'),
        ...
        data: {
            ...
            datasets: [
                ...
                },
                {
                    ...
                    borderWidth: 1,
                    data: [100, 50, 60, 47, 88, 27, 30],
                }
            ]
        }
    });

    var barChartImaGdass = new Chart(BARCHARTIMAGDASS, {
        type: 'bar',
        data: {
            labels: ["January", "February", "March", "April", "May", "June", "July"],
            datasets: [
    ...
    var barChartTarefas = new Chart(BARCHARTTAREFAS, {
        type: 'bar',
        data: {
            labels: ["January", "February", "March", "April", "May", "June", "July"],
            datasets: [
