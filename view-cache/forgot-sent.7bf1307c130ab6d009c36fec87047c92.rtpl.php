...
<h1 class="h3 mb-3 font-weight-normal text-light">Recupera Senha <b>PortalAPS</b></h1>    
<div class="col-6 alert alert-success" role="alert">
    <h4 class="alert-heading">E-mail enviado com sucesso!</h4>
    <hr>
    <p>Uma senha provisória foi enviada para seu e-mail. Acesse o Portal e altere a senha pessoal.</p>
</div>
<div class="col-6 mt-2">
    <a href="login" class="col-3 btn btn-lg btn-success btn-block" role="button">Fazer Login</a>
</div>     
