    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form autocomplete="off" role="form" action="admin-avisos/novo/<?php $counter1=-1;  if( isset($pages) && ( is_array($pages) || $pages instanceof Traversable ) && sizeof($pages) ) foreach( $pages as $key1 => $value1 ){ $counter1++; ?><?php if( $value1["i"] == $value1["page"] ){ ?><?php echo htmlspecialchars( $value1["i"], ENT_COMPAT, 'UTF-8', FALSE ); ?><?php } ?><?php } ?>" method="POST" enctype="multipart/form-data">
