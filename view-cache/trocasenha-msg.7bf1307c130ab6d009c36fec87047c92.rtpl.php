...
<h1 class="h3 mb-3 font-weight-normal text-light">Troca Senha <b>PortalAPS</b></h1>    
<div class="col-6 alert alert-success" role="alert">
    <h4 class="alert-heading"><?php echo htmlspecialchars( $msg, ENT_COMPAT, 'UTF-8', FALSE ); ?></h4>
</div>
